...
const superheroesDoublePower = superheroes.map((superheroe) => ({
  ...superheroe,
  power: superheroe.power * 2,
}));

console.log(superheroesDoublePower);

const superheroesNames = superheroes.map((superheroe) => superheroe.name);
